var HeaderVideo = (function ($, document) {
    ...
    var appendTeaserVideo = function() {
        if(Modernizr.video && !isMobile()) {
            ...
            html = '<video autoplay="true" loop="loop" id="teaser-video" class="teaser-video"><source src="'+videoDetails.id+'" type="video/mp4"><source src="'+source+'.ogv" type="video/ogg"></video>';
    ...
    var createFrame = function() {
        ...
        if(videoDetails.provider === 'youtube') {
            // var html = '<iframe id="video" src="/front/video/paris.mp4?autoplay=1" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>';
        }
            ...
            // var html = '<video autoplay="true" loop="loop" id="video"><source src="/front/video/paris.mp4" type="video/mp4"><source src="/front/video/paris.ogg" type="video/ogg"></video>';
        }
        return html;
    };
