...
@section('css')
@endsection
@section('title', 'Paquetes para Egipto y otros países')

@section('meta')
	<meta name="title" content="Paquetes para Egipto y otros países">
	<meta name="keywords" content="Paquetes para Egipto y otros países">
...
<div class="banners" style="background-image: url('{{ asset('/images/packages.jpg')}}')">
	{{-- <div class="parallax-content-1"> --}}
		...
		{{-- <div class="animated fadeInDown">
			<h1 style="font-size: 30px;">Paquetes para Egipto y otros países</h1> --}}
			{{-- <p style="font-size: 10px;"> --}}
			{{-- <p>
                Vamos Viajando ofrece paquetes a Egipto y otros países. Elija uno de nuestros tours combinados y prepárete para comenzar una inolvidable aventura!. ¡Desfrute al Máximo con nosotros!
			</p> --}}
			{{-- <div id="position">
				<div class="container">
					<ul>
						...
						<li>Tours-Combinados-a-Egipto-Con-Otros-Países</li>
					</ul>
				</div>
			</div>
		</div> --}}
						...
						<div class="row nomargin">
								<div class="col-lg-4 col-md-4 nopadding">
									<div class="product-pic">
										<a href="/Egypt/Camping-tour/{{ $package->slug }}">
								...
								<div class="col-lg-8 col-md-8 nopadding">
									<div class="product-body">
										...
										<a hreflang="es" href="/Egypt/Camping-tour/{{ $package->slug }}">
										<h2>{{ $package->name}}</h2>
										</a>
									...
									<div class="col-md-4">
										<div class="price_list text-right">
											<h6>{{Helper::currency_converter($package->startPrice)}}</h6>
											 <a hreflang="es" href="/Egypt/Camping-tour/{{ $package->slug }}" class="button">Details</a>
										</div>
									</div>
					...
					<div class="box_style_1 expose" id="booking_box">
						...
						<form action="/tailor" method="post">
							...
							<div class="form-group">
								...
								* Tell the specialist a bit about yoursel">
							</div>
