    ...
    <main class="package-det">
        <div class="container margin_60">
                ...
                <div class="bread">
                    <div class="container">
                        <ul class="list-unstyled">
                            ...
                            <li><a href="/nile-cruise" style="color: #000;">Cruises</a>
                            </li>
                            <li class="arrow"><i class="icon-angle-right"></i></li>
                            <li>{{ $package->name }}</li>
                        </ul>
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="header">
                                ...
                                <div class="slider">
                                    {{-- <section class="parallax-window" data-parallax="scroll" data-image-src="{{ asset('/images/packages/'.$package->mainImage)}}" title="{{$package->altMain}}" data-natural-width="100%" data-natural-height="auto">
								</section> --}}
            ...
            <div class="container">
                <div class="desc">
                    <div class="details">
                        <h4 class="line"><span>Reveiws</span></h4>
