...
@section('meta')
	<meta name="title" content="Cruceros por el nilo | Cruceros en Egipto">
	<meta name="keywords" content="Cruceros por el nilo | Cruceros en Egipto">
	<meta name="description" content="La aventura de hacer curceros por el nilo, te da unas experiencias agradables gozando de Luxor y Aúan o viceversa con pensión completa !Reserve ya!">
@endsection
@section('content')

<div class="banners" style="background-image: url('{{ asset('/images/Cruceros.jpeg') }}')">
	{{-- <div class="parallax-content-1"> --}}
			...
			<div class="d-none d-lg-block">
				<img src="{{ asset('/images/1.png')}}" style="z-index: 15000;width: 100px;position: absolute;right: 3%;top: 20%;" alt="Nile Cruises" data-retina="true">
			</div> --}}
			<div class="overlay">
				<div class="container">
					<div class="dest_con">
		...
		{{-- <div class="animated fadeInDown">
            <h1>Cruceros por el nilo</h1> --}}
            {{-- <p>
				Hay muchas opciones de cruceros por el Nilo desde Luxor hasta Asún al estilo que quieras, entonces, ¿qué estás buscando? Aquí te presentamos lo más ideal con valores increíbles.
            </p> --}}
			{{-- <div id="position">
				<div class="container">
					<ul>
						...
						<div class="row nomargin">
								<div class="col-lg-4 col-md-4 nopadding">
									<div class="product-pic">
										<a href="/nile-cruise/{{ $package->slug }}">
											{{-- <img width="100%" height="100%" src="{{ 'images/packages/1648722848packages2.jpeg'}}" title="{{ $package->altShort }}"> --}}
								...
								<div class="col-md-4">
									<div class="price_list text-right">
										<h6>{{Helper::currency_converter($package->startPrice)}}</h6>
									     <a href="/nile-cruise/{{ $package->slug }}" class="button">Details </a>
									</div>
								</div>
				...
				<div class="theiaStickySidebar">
					<div class="box_style_1 expose" id="booking_box">
						...
						<form action="/tailor" method="post">
							...
							<input name="package" type="hidden" value="Nile Cruise">
...
<script>
	...
	var datepicker2 = (date.getDate() + 2) + '/' + (date.getMonth() + 1) + '/' +  date.getFullYear();
