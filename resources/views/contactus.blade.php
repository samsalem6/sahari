...
@section('css')
@endsection
@section('title','Contáctanos - Vamos Viajando')
@section('meta')
	<meta name="title" content="Contáctanos - Vamos Viajando">
	<meta name="keywords" content="Contáctanos - Vamos Viajando">
	<meta name="description" content="Rellena el formulario y uno de nuestros consultores expertos en viajes estará listo para enviarle el mejor paquete a Egipto de acuerdo con su disponibilidad.">
@endsection
@section('content')

<div class="banners-b text-center" style="background-image: url('../../images/contactus2.jpg')">
	<div class="overlay">
				...
				<div class="contact_body">
					<div class="row">
							...
							<div class="contact_form">
								<form method="post" action="/contact" id="contactform">
									...
									<div class="row">
										<div class="col-sm-6">
											<div class="form-group">
												...
												type="text" class="form-control" id="name_contact" name="name_contact" placeholder="Nombre">
											</div>
										</div>
										<div class="col-sm-6">
											<div class="form-group">
												...
												oninvalid="this.setCustomValidity('Este Campo es requerido')"
												oninput="setCustomValidity('')"
												type="text" class="form-control" id="lastname_contact" name="lastname_contact" placeholder="Apellido">
											</div>
										</div>
									</div>
									<!-- End row -->
									<div class="row">
										...
										<div class="col-sm-6">
											<div class="form-group">
												<label>Teléf o Whatsapp</label>
												<input
												required=""
												oninvalid="this.setCustomValidity('Este Campo es requerido')"
												oninput="setCustomValidity('')"
												type="text" id="whats" name="whats" class="form-control" placeholder="Teléf o Whatsapp">
											</div>
										</div>
										{{-- <div class="form-group col-md-3 col-sm-6 col-xs-12">
											<label><i class="icon_set_1_icon-37"></i> Nacionalidad</label>
											<select required=""
											oninvalid="this.setCustomValidity('Este campo es requerido')"
											oninput="setCustomValidity('')"
									...
									<div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group">
													<label><i class="icon-calendar-7"></i> Destinos *</label>
												...
												<div class="col-sm-6">
													<div class="form-group">
														<label>Presupuesto *<small> Por persona (vuelos internacionales NO incluidos)</small></label>
								...
								<br>
									<div class="row">
										<div class="col-sm-12">
											...
											oninvalid="this.setCustomValidity('Este campo es requerido')"
											oninput="setCustomValidity('')"
											 rows="5" id="comment" name="comment" class="form-control" placeholder="Por favor describa: si desea paquete, cuántos días y fecha de viaje." style="height:200px;"></textarea>
											</div>
										</div>
									</div>
									{{-- <div class="row"> --}}
										...
										<div class="text-right">
											<input type="submit" value="Enviar Mensaje" class="btn-main" id="submit-contact">
										</div>
									{{-- </div> --}}
								</form>
							</div>
						...
						<div class="col-lg-4 col-md-5">
							<div class="address">
								<h5>Manejado Por:</h5>
								<div>Business Travel Experts LLC.</div>
								@if ($contactss->email)
								...
								<br>
								@if ($contactss->phone)
								<div>Oficina: {{ $contactss->phone }}</div>
								@endif
								@if ($contactss->fax)
								<div>Fax: {{ $contactss->fax }}</div>
								@endif
							</div>
						</div>
						@endif
