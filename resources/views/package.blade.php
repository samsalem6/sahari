	...
	<div class="container margin_60">
			...
			<div class="bread">
				<div class="container">
					<ul class="list-unstyled">
						<li><a href="/" style="color: #000;">Inicio</a>
						</li>
						<li class="arrow"><i class="icon-angle-right"></i></li>
						<li><a href="/{{tdestinations($package->id)}}" style="color: #000;">Paquetes</a>
						</li>
						<li class="arrow"><i class="icon-angle-right"></i></li>
						<li>{{$package->name}}</li>
					</ul>
										...
										<div class="row">
											<div class="col-lg-12">
												...
												<div class="row">
                                                        {!! $package->price !!}
													<?php
                                                    if(isset($package_prices) && !empty($package_prices)){
													$namesCounter = 0;
			...
			<aside class="col-lg-4" id="sidebar">
				...
				<div class="theiaStickySidebar">
					<div class="inquire_head" id="booking_box">
						<div class="row">
							<div class="col-6">
								<h4 class="inner">Envía Tu Solicitud</h4>
							</div>
							<div class="col-6">
								<div class="price text-right">
									<p>Desde</p><h6>{{Helper::currency_converter($package->startPrice)}}</h6>
								</div>
							</div>
						</div>
							...
							<div class="box_style_1 expose" id="booking_box">
								...
								<form action="/packages" method="post">
									...
									<button type="submit" class="btn btn-primary" style="width: 100%;">Envía</button>
								</form>
							</div>
							<!--/box_style_1 -->
						</div>
		...
		<div class="container">
		  ...
		  <div class="container">
			<div class="desc">
			  <div class="details">
				<h5 class="line"><span>últimos artículos</span></h5>
				<div class="d-sm-block">
					<div class="row">
