...
.controls input {
    ...
    <hr>
    <form role="form" method="POST" action="{{action('PackageController@update', $package)}}" enctype="multipart/form-data" class="form-horizontal form-groups-bordered">
        {{ csrf_field() }}
        ...
        <div class="form-group {{ $errors->has('runs_on') ? ' has-error validate-has-error' : '' }} ">
            ...
            <div class="col-sm-8">
                <div id="datePick"></div>
                <input type="text" class="form-control"  value="{{ $package->runs_on }}" autocomplete="off" placeholder="Pick the runs on dates" name="runs_on" id="runs_on">
        ...
        <div class="form-group {{ $errors->has('popular') ? ' has-error validate-has-error' : '' }} ">
            ...
            <div class="col-sm-8">
                    <div class="radio">
                        <label>
                            <input type="radio" name="popular" id="null" value="null" {{ $package->popular == 'null' ? 'checked=""' : '' }} >Null
                        </label>
                        <label>
                            <input type="radio" name="popular" id="popular" value="popular"{{ $package->popular == 'popular' ? ' checked=""' : '' }} >Popular
                        </label>
                        <label>
                            <input type="radio" name="popular" id="toprated" value="toprated" {{ $package->popular == 'toprated' ? ' checked=""': '' }}>Top rated
                        </label>
                    </div>
        ...
        <div class="form-group {{ $errors->has('type') ? ' has-error validate-has-error' : '' }} ">
            ...
            <div class="col-sm-8">
                <div class="radio">
                    <label>
                        <input type="radio" name="type" id="combined" {{ $package->type == 'combined' ? 'checked=""' : '' }} value="combined">Combined
                    </label>
                    <label>
                        <input type="radio" name="type" id="TravelPackages" {{ $package->type == 'TravelPackages' ? 'checked=""' : '' }} value="TravelPackages">Travel Packages
                    </label>
                </div>
        ...
        <div class="form-group {{ $errors->has('inHome') ? ' has-error validate-has-error' : '' }} ">
            ...
            <div class="col-sm-8">
                <input type="checkbox" class="form-check-input" {{ $package->inHome == true ? 'checked' : '' }} id="inHome" name="inHome">
        ...
        <div class="form-group {{ $errors->has('landing') ? ' has-error validate-has-error' : '' }} ">
            ...
            <div class="col-sm-8">
                <input type="checkbox" class="form-check-input" {{ $package->landing == true ? 'checked' : '' }} id="landing" name="landing">
            ...
            <div class="col-sm-8">
                <select name="destination_id" class="form-control">
                    @foreach ($destinations as $destination)
                        <option {{ $destination->id === $package->destination_id ? "selected" : "" }} value="{{$destination->id}}">{{$destination->name}}</option>
                    @endforeach
                </select>
        ...
        <div class="form-group {{ $errors->has('hot') ? ' has-error validate-has-error' : '' }} ">
            ...
            <div class="col-sm-8">
                <select required name="hot" class="form-control">
                    <option {{ $package->hot === 'null' ? "selected" : "" }} value="null">Null</option>
                    <option {{ $package->hot === 'christmas' ? "selected" : "" }} value="christmas">Viajes Fin de Año 2021</option>
                    <option {{ $package->hot === 'easter' ? "selected" : "" }} value="easter">Tours En Semana Santa 2021</option>
                    <option {{ $package->hot === 'Offers' ? "selected" : "" }} value="Offers">Promociones de Viajes</option>
                    <option {{ $package->hot === 'Cruceros-Nilo' ? "selected" : "" }} value="Cruceros-Nilo">Cruceros Nilo</option>
                </select>
        ...
        <div class="form-group {{ $errors->has('landingTitel') ? ' has-error validate-has-error' : '' }} ">
            ...
            <div class="col-sm-8">
                <input name="landingTitel" id="landingTitel" type="text" class="form-control" value="{{ $package->landingTitel }}">
        ...
        <div class="form-group {{ $errors->has('metaTitle') ? ' has-error validate-has-error' : '' }} ">
            ...
            <div class="col-sm-8">
                <input name="metaTitle" id="metaTitle" type="text" class="form-control" value="{{ $package->metaTitle }}">
        ...
        <div class="form-group {{ $errors->has('metaKeywords') ? ' has-error validate-has-error' : '' }} ">
            ...
            <div class="col-sm-8">
                <input name="metaKeywords" id="metaKeywords" type="text" class="form-control" value="{{ $package->metaKeywords }}" >
        ...
        <div class="form-group {{ $errors->has('metaDescription') ? ' has-error validate-has-error' : '' }} ">
            ...
            <div class="col-sm-8">
                <input name="metaDescription" id="metaDescription" type="text" class="form-control" value="{{ $package->metaDescription }}">
        ...
        <div class="form-group {{ $errors->has('order') ? ' has-error validate-has-error' : '' }} ">
            ...
            <div class="col-sm-8">
                <input name="order" id="order" type="text" class="form-control" value="{{ $package->order }}">
        ...
        <div class="form-group {{ $errors->has('slug') ? ' has-error validate-has-error' : '' }} ">
            ...
            <div class="col-sm-8">
                <input name="slug" id="slug" type="text" class="form-control" value="{{ $package->slug }}">
            ...
            <div class="col-sm-5">
                    <div class="radio">
                        <label class="col-sm-2 control-label">
                            <input type="radio" name="viewInSite" id="0" value="0" {{$package->viewInSite == 0? 'checked=""':""}}> Off
                        </label>
                        <label class="col-sm-2 control-label">
                            <input type="radio" name="viewInSite" id="1" value="1" {{$package->viewInSite == 1? 'checked=""':""}}> On
                        </label>
                    </div>
        ...
        <div class="form-group {{ $errors->has('altMain') ? ' has-error validate-has-error' : '' }} ">
            ...
            <div class="col-sm-8">
                <input name="altMain" id="altMain" type="text" class="form-control" value="{{ $package->altMain }}">
        ...
        <div class="form-group {{ $errors->has('altShort') ? ' has-error validate-has-error' : '' }} ">
            <label for="altShort" class="col-sm-2 control-label">Alt for Main Image</label>
            <div class="col-sm-8">
                <input name="altShort" id="altShort" type="text" class="form-control" value="{{ $package->altShort }}">
        ...
        <div class="form-group {{ $errors->has('name') ? ' has-error validate-has-error' : '' }} ">
            ...
            <div class="col-sm-8">
                <input name="name" id="name" type="text" class="form-control" value="{{ $package->name }}" >
        ...
        <div class="form-group {{ $errors->has('tourType') ? ' has-error validate-has-error' : '' }} ">
            ...
            <div class="col-sm-8">
                <input name="tourType" id="tourType" type="text" class="form-control" value="{{ $package->tourType }}">
        ...
        <div class="form-group {{ $errors->has('duration') ? ' has-error validate-has-error' : '' }} ">
            ...
            <div class="col-sm-8">
                <input name="duration" id="duration" type="text" class="form-control" value="{{ $package->duration }}">
        ...
        <div class="form-group {{ $errors->has('tourRun') ? ' has-error validate-has-error' : '' }} ">
            ...
            <div class="col-sm-8">
                <input name="tourRun" id="tourRun" type="text" class="form-control" value="{{ $package->tourRun }}">
        ...
        <div class="form-group {{ $errors->has('stars') ? ' has-error validate-has-error' : '' }} ">
            ...
            <div class="col-sm-8">
                <input name="stars" id="stars" type="text" class="form-control" value="{{ $package->stars }}">
        ...
        <div class="form-group {{ $errors->has('starsNum') ? ' has-error validate-has-error' : '' }} ">
            ...
            <div class="col-sm-8">
                <input name="starsNum" id="starsNum" type="text" class="form-control" value="{{ $package->starsNum }}">
        ...
        <div class="form-group {{ $errors->has('startPrice') ? ' has-error validate-has-error' : '' }} ">
            ...
            <div class="col-sm-8">
                <input name="startPrice" id="startPrice" type="text" class="form-control" value="{{ $package->startPrice }}">
            ...
            <div class="widget-title">
                ...
                <div class="widget-body form">
                        ...
                        if(!empty($pricingTemplatesID) || isset($pricingTemplatesID)){
                                 ...
                                 ?>
                                     <li id="prog_id_<?php echo $pricetemplate['id'];?>">
                                       <?php echo $pricetemplate['name'];?>
             ...
             <a href="#" onclick="deleteProgamID(<?php echo $pricetemplate['id'];?>);return false;">[X]</a>
                                        <input name="pricingTemplates[<?php echo $count_items; ?>]" type="hidden" value="<?php echo $pricetemplate['id'];?>">
                                     </li>
                                <?php
                            $count_items++;
                                }
        ...
        <div class="form-group {{ $errors->has('discount') ? ' has-error validate-has-error' : '' }} ">
            ...
            <div class="col-sm-8">
                <input name="discount" id="discount" type="text" class="form-control" value="{{ $package->discount }}">
        ...
        <div class="form-group {{ $errors->has('description') ? ' has-error validate-has-error' : '' }} ">
            ...
            <div class="col-sm-8">
                <textarea name="description" id="description" type="text" class="form-control " >{!! $package->description !!}</textarea>
        ...
        <div class="form-group {{ $errors->has('shortDescription') ? ' has-error validate-has-error' : '' }} ">
            ...
            <div class="col-sm-8">
                <textarea name="shortDescription" id="shortDescription" type="text" class="form-control " >{!! $package->shortDescription !!}</textarea>
        ...
        <div class="form-group {{ $errors->has('Inclusions') ? ' has-error validate-has-error' : '' }} ">
            ...
            <div class="col-sm-8">
                <textarea name="Inclusions" id="Inclusions" type="text" class="form-control " >{!! $package->Inclusions !!}</textarea>
        ...
        <div class="form-group {{ $errors->has('Exclusions') ? ' has-error validate-has-error' : '' }} ">
            ...
            <div class="col-sm-8">
                <textarea name="Exclusions" id="Exclusions" type="text" class="form-control " >{!! $package->Exclusions !!}</textarea>
        ...
        <div class="form-group {{ $errors->has('itinerary') ? ' has-error validate-has-error' : '' }} ">
            ...
            <div class="col-sm-8">
                <textarea name="itinerary" id="itinerary" type="text" class=" form-control" >{!! $package->itinerary !!}</textarea>
        ...
        <div class="form-group {{ $errors->has('price') ? ' has-error validate-has-error' : '' }} ">
            ...
            <div class="col-sm-8">
                <textarea name="price" id="price" type="text" class=" form-control" >{!! $package->price !!}</textarea>
    ...
    <?php $dates = (!empty($package->runs_on)) ? explode(', ', $package->runs_on) : ''; ?>
    <script>
        $(document).ready(function() {
            ...
            $('#datePick').multiDatesPicker({
                'altField' : '#runs_on',
                dateFormat: 'dd/mm/yy',
                addDates: <?php echo stripslashes(json_encode($dates)); ?>,
            });
        });
    </script>
