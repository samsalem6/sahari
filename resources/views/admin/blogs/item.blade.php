        ...
        <div class="col-md-12">
            <div class="panel panel-primary">
                <div class="panel-body">
                    <form role="form" class="form-horizontal form-groups-bordered" method="POST" action="/blogItems/edit" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="form-group text-center">
                                    <img style="width:400px" src="/images/blogs/{{ $blogList->image }}">
                                </div>
                                ...
                                <div class="form-group col-md-10"">
                                    ...
                                    <div class="input-group col-md-10">
                                        <input type="text" class="form-control" name="imageAlt" id="imageAlt" placeholder="imageAlt" value="{{$blogList->imageAlt}}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-10"">
                                    ...
                                    <div class="input-group col-md-10">
                                        <input type="text" class="form-control" name="imageTitle" id="imageTitle" placeholder="imageTitle" value="{{$blogList->imageTitle}}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-10"">
                                    ...
                                    <div class="input-group col-md-10">
                                        <input type="text" class="form-control" name="title" id="title" placeholder="title" value="{{$blogList->title}}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-10"">
                                    ...
                                    <div class="input-group col-md-10">
                                        <input type="text" class="form-control" name="order" id="order" placeholder="order" value="{{(int)Str::after($blogList->order,$blogList->blog_id)}}">
                                    </div>
                                </div>
                                <span id="name-error" class="validate-has-error">{{ $errors->first('order', ':message') }}</span>

                                <input name="id" type="hidden" value="{{ $blogList->id }}">

                                <div class="form-group col-md-10"">
                                    <label class="col-sm-2 control-label">Description</label>

                                <div class="input-group col-md-10">
                                    <textarea name="Description" id="Description" type="text" class="form-control " >{!!$blogList->Description!!}</textarea>
