        ...
        <div class="col-md-12">
            <div class="panel panel-primary">
                <div class="panel-body">
                    <form role="form" class="form-horizontal form-groups-bordered" method="POST" action="/admin/blogItems/store" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input name="blog_id" type="hidden" value="{{ request()->id }}">
            ...
            <tbody>
                @if(count($items) > 0)
                    @foreach($items as $item)
                        <tr>
                            <td style="text-align:center">{{  (int)Str::after($item->order,$item->blog_id) }}</td>
                            ...
                            <div class="col-sm-3">
                                <a href="/admin/blogItems/edit/{{$item['id']}}"  class="btn btn-info btn-icon icon-left">
                                    Edit
                            ...
                            <div class="col-sm-3">
                                <a href="/admin/blogItems/destroy/{{$item['id']}}"  class="btn btn-red btn-icon icon-left">
                                    Delete
