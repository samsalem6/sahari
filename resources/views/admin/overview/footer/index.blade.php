...
<hr>
<form role="form" method="POST" action="{{action('ReasonsController@updateAbout', $about)}}" enctype="multipart/form-data" class="form-horizontal form-groups-bordered">
    {{ csrf_field() }}
    @method('PUT')
    ...
    <div class="form-group {{ $errors->has('body') ? ' has-error validate-has-error' : '' }} ">
        ...
        <div class="col-sm-8">
            <textarea  name="body" id="body" type="text" class="form-control" rows="5">{{ $about->body }}</textarea>
