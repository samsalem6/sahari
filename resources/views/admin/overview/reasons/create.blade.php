...
@section('title', __('Add Reasons'))
@section('sitetitle', __('Add Reasons'))
@section('reasons', 'visible opened active')
@section('content')

<div class="notes-env">
    <div class="notes-header">
        <h2>@lang('Add Reasons')</h2>
...
<form role="form" method="POST" action="{{url('/reasons')}}" enctype="multipart/form-data" class="form-horizontal form-groups-bordered">
    {{ csrf_field() }}
