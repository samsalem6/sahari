...
@section('content')
    ...
    <hr>
    <form role="form" method="POST" action="{{action('AboutController@update', $about)}}" enctype="multipart/form-data" class="form-horizontal form-groups-bordered">
        {{ csrf_field() }}
        ...
        <div class="form-group {{ $errors->has('title') ? ' has-error validate-has-error' : '' }} ">
            ...
            <div class="col-sm-8">
                <input name="title" id="title" type="text" class="form-control" value="{{ $about->title }}">
        ...
        <div class="form-group {{ $errors->has('body') ? ' has-error validate-has-error' : '' }} ">
            ...
            <div class="col-sm-8">
                <textarea data-stylesheet-url="/admin/css/wysihtml5-color.css" name="body" id="body" type="text" class=" form-control" id="field-6" >{{ $about->body }}</textarea>
        ...
        <div class="form-group ">
            <div class="text-center">
                ...
                <a href="/admin/abouts" class="btn btn-lg btn-red btn-icon">
                    @lang('lang.Cancel')
