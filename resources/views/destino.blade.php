...
@section('css')
    ...
    <script type="application/ld+json">

        {
          ...
          "name": "{{$package->name}}",
          "image": [
            "{{ asset('/images/packages/'.$package->mainImage)}}"
          ],
          "description": "{!! substr (strip_tags($package->description), 0, 500) !!}",
          "aggregateRating": {
            "@type": "AggregateRating",
            "bestRating": "5",
            "ratingValue": "4.5",
            "reviewCount": "{{ $package->starsNum }}"
          },
          "offers": {
            "@type": "Offer",
            "priceCurrency": "USD",
              "price": "{{ $package->startPrice}}",
...
@endsection
@section('title', $package->metaTitle)
@section('meta')
    <meta name="title" content="{{ $package->metaTitle }}">
    <meta name="keywords" content="{{ $package->metaKeywords }}">
    <meta name="description" content="{{ $package->metaDescription . $package->id }}">
@endsection
@section('content')
    ...
    <main class="package-det">
        <div class="container margin_60">
                ...
                <div class="bread">
                    <div class="container">
                        <ul class="list-unstyled">
                            <li><a href="/" style="color: #000;">Home</a>
                            </li>
                            <li class="arrow"><i class="icon-angle-right"></i></li>
                            <li><a href="/{{ tdestinations($package->id) }}" style="color: #000;">Packages</a>
                            </li>
                            <li class="arrow"><i class="icon-angle-right"></i></li>
                            <li>{{ $package->name }}</li>
                        </ul>
                    ...
                    <div class="row">
                            ...
                            <div class="header">
                                ...
                                <div class="head text-center">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3 col-6">
                                            <span>{{ $package->tourRun }}</span>
                                        </div>
                                    </div>
                                </div>
                                <p>{!! $package->description !!}</p>
                                <div class="slider">
                                    {{-- <section class="parallax-window" data-image-src="{{ asset('/images/packages/'.$package->mainImage)}}" title="{{$package->altMain}}" data-natural-width="100%" data-natural-height="auto">
								</section> --}}
                                    <div class="owl-carousel owl-theme">
                                        <img src="{{ asset('/images/packages/' . $package->mainImage) }}"
                                            alt="{{ $package->altMain }}" width="100%" height="auto">
                                        @foreach ($package->Gallery as $gallery)
                                            <img src="{{ asset('/images/packages/' . $gallery->image) }}"
                                                alt="{{ $gallery->altMain }}" width="100%" height="auto">
                                        @endforeach
                                    </div>
                                </div>
                            </div>
                            <div class="tabs">
                                <div class="tab-head d-none d-sm-block">
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" aria-current="page" id="overview-tab"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" aria-current="page" id="itinerary-tab" data-toggle="tab"
                                                href="#itinerary" role="tab" aria-controls="itinerary"
                                                aria-selected="true">
                                                <h2>Itinerary</h2>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" aria-current="page" id="prices-tab" data-toggle="tab"
                                                href="#prices" role="tab" aria-controls="prices" aria-selected="true">
                                                <h2>Prices & Accommodation</h2>
                                            </a>
                                        </li>
                                        @if (count($package->General) > 0)
                                            <li class="nav-item">
                                                <a class="nav-link" aria-current="page" id="info-tab" data-toggle="tab"
                                ...
                                <div class="tab_head tab_head_m d-sm-none">
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" aria-current="page" id="prices-tab" data-toggle="tab"
                                                href="#prices" role="tab" aria-controls="prices"
                                                aria-selected="true">
                                                <h2>Prices & Accommodation</h2>
                                            </a>
                                        </li>
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="overview" role="tabpanel"
                                        ...
                                        <div class="desc">
                                            ...
                                            <div class="itinerary-glance">
                                                <ul class="list-unstyled">
                                                    @foreach ($package->itineraries as $key => $itineraries)
                                                        @foreach ($itineraries->items as $item)
                                                            <li>
                                                                <div class="row">
                                    ...
                                    <div class="tab-pane fade" id="itinerary" role="tabpanel"
                                        ...
                                        <div class="desc itinary">
                                            <h4>Itinerary at a Glance</h4>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    {{-- <ol class="det">
													@if (count($package->itineraries) > 0)
														@foreach ($package->itineraries as $key => $itineraries)
														<li class="itin_item">
															<div class="num text-center">{{ $key + 1 }}</div>
															<a class="program_itinerary_box_title" style="cursor: pointer;"><h5>{{ $itineraries->title }}</h5></a>
															<p class="desc">{!!$itineraries->body!!}</p>
														</li>
														@endforeach
													@endif
												</ol> --}}
                                                                    ...
                                                                    <div class="card-header">
                                                                        <h4>
                                                                            <a class="accordion-toggle"
                                                                                ...
                                                                                data-parent="#pricing"
                                                                                href="#collapseOne_pricing{{ $itineraries->id }}">{{ $itineraries->title }}<i
                                                                                    class="indicator {{ $loop->first ? 'icon-right-open' : 'icon-down-open' }}  float-right"></i></a>
                                                                        </h4>
                                                                    </div>
                                                                    <div id="collapseOne_pricing{{ $itineraries->id }}"
                                                                                        ...
                                                                                        <div class="card-header">
                                                                                            <h4>
                                                                                                <a class="accordion-toggle"
                                                                                                    data-toggle="collapse"
                                                                                                    data-parent="#privacy"
                                                                                                    href="#collapseOne_privacy{{ $item->id }}">{{ $item->title }}<i
                                                                                                        class="indicator {{ $loop->first ? 'icon-right-open' : 'icon-down-open' }}  float-right"></i></a>
                                                                                            </h4>
                                                                                        </div>
                                                                                        <div id="collapseOne_privacy{{ $item->id }}"
                                                                                            class="collapse {{ $loop->first ? 'show' : '' }}"
                                                                                            data-parent="#privacy">
                                                                                            <div class="card-body">
                                                                                                {!! $item->body !!}
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-12">
                                                                            <div class="new-prices-tbl">
                                                                                ...
                                                                                <div
                                                                                    class="new-prices-tbl_data d-flex align-items-center justify-content-between">
                                                                                    ...
                                                                                    <div class="new_price_box_price_price">
                                                                                        <span class='pricelarge2'>
                                                                                            <span
                                                                                                class='currencySign'>$</span>
                                                                                            <span
                                                                                                id="min_price<?php echo trim($pricesValue['value']); ?>"
                                                                                                class="convertable">
                                                                                                {{ round($pricesValue['value'] * exchangeRates(), 0) }}
                                                                                            </span>
                                                                                        </span>
                                                                                        <input type="hidden"
                                                                                            id="hmin_price<?php echo trim($pricesValue['value']); ?>"
                                                                                            value="<?php echo trim($pricesValue['value']); ?>" />
                                                                                    </div>
                                                                                </div>
                                                                                <?php } ?>
                                                                                <?php } ?>
                                                                ...
                                                                <div class="new_price_box_hotels">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-6 col-12">
                                                                            <a href="<?php echo $hotelData[$hotelCounter]['link']; ?>"
                                                                                target="_blank">
                                                                                <div class="new-hotel-boxes">
                                                                                    <div class="new-hotel-boxes-img"
                                                                                        style="background-image: url('{{ asset('/images/packages/' . $hotelData[$hotelCounter]['image']) }}')"
                                                                                        title="<?php echo $hotelData[$hotelCounter]['name']; ?>"></div>
                                                                                    <div class="new-hotel-boxes-title">
                                                                                        <?php echo $hotelData[$hotelCounter]['name']; ?>
                                                                                        <ul class="list-inline">
                                                                                            <?php for ($count = 1; $count <= 5; $count ++) {
																								if ($count <= $hotelData[$hotelCounter]['stars']) { ?>
                                                                                            <li value="<?php echo $count; ?>"
                                                                                                class="star"><img
                                                                                                    src="{{ asset('/images/star-filled.svg') }}"
                                                                                                    alt="<?php echo $hotelData[$hotelCounter]['name']; ?>"
                                                                                                    title="<?php echo $hotelData[$hotelCounter]['name']; ?>">
                                                                                            </li>
                                                                                            <?php } else { ?>
                                                                                            <li value="<?php echo $count; ?>"
                                                                                                class="star"><img
                                                                                                    src="{{ asset('/images/star-open.svg') }}"
                                                                                                    alt="<?php echo $hotelData[$hotelCounter]['name']; ?>"
                                                                                                    title="<?php echo $hotelData[$hotelCounter]['name']; ?>">
                                                                                            </li>
                                                                                            <?php }
                        ...
                        <aside class="col-lg-4" id="sidebar">
                            <div class="text-right" style="margin-bottom: 10px;">
                                <a href="https://www.feefo.com/reviews/vamos-viajando" target="_blank"><img
                                        alt="Feefo logo" border="0"
                                        src="https://api.feefo.com/api/logo?merchantidentifier=vamos-viajando"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="price text-right">
                                                <p>From</p>
                                                <h6>{{ Helper::currency_converter($package->startPrice) }}</h6>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <form action="/packages" method="post">
                                        ...
                                        <div class="row ">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group ">
                                                    <input required=""
                                                        ...
                                                        id="name_contact" name="name" value="{{ old('name') }}"
                                                        placeholder="Name *">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input required="" readonly='true'
                                                        class="date-pick form-control {{ $errors->has('Arrival') ? ' is-invalid' : '' }}"
                                                        data-date-format="d/m/yyyy" name="Arrival" type="text"
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input readonly='true' required=""
                                                        oninvalid="this.setCustomValidity('this field is required')"
                                                        oninput="setCustomValidity('')"
                                                        class="date-pick2 form-control {{ $errors->has('Departure') ? ' is-invalid' : '' }}"
                                                        data-date-format="d/m/yyyy" name="Departure" type="text"
                                                        placeholder="d/m/aaaa">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <select required=""
                                                    oninvalid="this.setCustomValidity('this field is required')"
                                                    oninput="setCustomValidity('')" name="nationality"
                                            ...
                                            <div class="form-group col-md-5 col-sm-5 col-xs-5">
                                                <select required=""
                                                    oninvalid="this.setCustomValidity('this field is required')"
                                                    oninput="setCustomValidity('')" name="countryCode"
                                                    class="form-control {{ $errors->has('countryCode') ? ' is-invalid' : '' }}">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="form-group">
                                                    <input required=""
                                                        oninvalid="this.setCustomValidity('this field is required')"
                                                        oninput="setCustomValidity('')" value="{{ old('whats') }}"
                                                        type="text"
                                                        class="form-control {{ $errors->has('whats') ? ' is-invalid' : '' }}"
                                                        id="whats" name="whats" placeholder="Number or Whatsapp *">
                                                </div>
                                            </div>
										...
										<div class="col-sm-12">
											<div class="form-group">
												<label>Presupuesto * <br><small> Por persona (vuelos internacionales NO incluidos)</small></label>

												<select name="budget" class="form-control">
													<option value="">Presupuesto *</option>
													<option value="Por Persna $1000 - $2000">Por Persna $1000 - $2000</option>
													<option value="Por Persona $2000 - $3000">Por Persona $2000 - $3000</option>
													<option value="Por Persona $3000 en adelante">Por Persona $3000 en adelante</option>
												</select>
											</div>
										</div>
									</div> --}}
                                        ...
                                        <button type="submit" class="btn btn-primary" style="width: 100%;">INQUIRE
                                            NOW!</button>
                                    </form>
                                </div>
                                <!--/box_style_1 -->
            ...
            <div class="container">
                <div class="desc">
                    <div class="details">
                        <h4 class="line"><span>Reviews</span></h4>
            ...
            <div class="container">
                <div class="desc">
                    <div class="details">
                        <h5 class="line"><span>Latest Articles</span></h5>
                        <div class="d-sm-block">
                            <div class="row">
        ...
        <a id="check-Inquire" href="#sidebar"
            style="background: #00aeff; color: #fff;font-size: 22px;text-align: center ;z-index:100001; width: 100%"
            class="d-lg-none back-Inquire btn_full">Envía Tu Solicitud</a>
...
@section('js')
    ...
    <script>
        $(window).scroll(function() {
            var sidebar = document.getElementById("sidebar").getBoundingClientRect().top;
            // var endsidebar = document.getElementById("endsidebar").getBoundingClientRect().top;
        ...
        $(document).ready(function() {
            $(window).scroll(function() {
                // $('#check-Inquire').fadeIn();
                let x = document.getElementById('sidebar').offsetTop;
                let y = document.getElementById('title').offsetTop;
                if (document.documentElement.scrollTop > x && document.documentElement.scrollTop < document
                    .getElementById('title').offsetTop) {
                    $('#check-Inquire').fadeOut();
                } else {
                    $('#check-Inquire').fadeIn();
                }
            });
    ...
    <script type="text/javascript"
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCF69vVy2PRgFlKV9O8Aqol8adOCQi1rRo"></script>
