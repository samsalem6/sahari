...
@section('css')
@endsection
@section('title', 'Personaliza Tu Viaje')

@section('meta')
	<meta name="title" content="Personaliza Tu Viaje">
	<meta name="keywords" content="Personaliza Tu Viaje">
	<meta name="description" content="Vamos personalizar tu viaje y te mandamos un presupuesto adequado, también, uno de nuestros expertos en viajes se pondrá en contacto contigo.">
@endsection
@section('content')

<div class="banners-b text-center" style="background-image: url('../../images/tailormake2.jpg')">
	<div class="overlay">
			{{-- <div class="d-lg-none">
				...
				<div class="container">
					<div class="animated fadeInDown">
						<h1>Personaliza Tu Próximo Viaje</h1>
						{{-- <p>Rellena el formulario con tus respuestas y vamos a personalizar tu viaje y te mandamos un presupuesto adequado, también, uno de nuestros expertos en viajes se pondrá en contacto contigo.</p> --}}
						<div id="position">
							<div class="container">
						...
						<div class="col-lg-9">
							<div class="billing-details">
								<div class="shop-form">
									...
									<p>Con Vamos puedes personalizar tu viaje como prefieras.</p>
									<form method="post" action="/tailor">
										...
										<div class="row">
											...
											<div class="form-group col-sm-3">
												<label><i class="icon-flag"></i> Nacionalidad *</label>
												<select required=""
												oninvalid="this.setCustomValidity('Este Campo es requerido')"
												oninput="setCustomValidity('')" name="nationality" class="form-control {{ $errors->has('nationality') ? ' is-invalid' : '' }}">
											...
											<div class="form-group col-sm-3">
												<label><i class="icon-mobile"></i> Código *</label>
												<select required=""
												oninvalid="this.setCustomValidity('Este Campo es requerido')"
											...
											<div class="col-sm-6">
												<div class="form-group">
													<label><i class="icon-phone"></i> Teléf o Whatsapp *</label>
													<input required=""
													oninvalid="this.setCustomValidity('Este Campo es requerido')"
											...
											<div class="col-sm-3">
												<div class="form-group">
													<label><i class="icon-location"></i> Destinos *</label>
											...
											{{-- <div class="row col-sm-12"> --}}
												...
												<div class="col-sm-4 text-right">
													<button type="submit" class="btn-main">Envía Tu Solicitud</button>
												</div>
											{{-- </div> --}}
									</form>
								</div>
