			...
			<div class="bread">
				<div class="container">
					<ul class="list-unstyled">
						<li><a hreflang="es" href="/" style="color: #000;">Home</a>
						</li>
						<li class="arrow"><i class="icon-angle-right"></i></li>
						<li><a hreflang="es" href="/Egypt/Camping-tour" style="color: #000;">Camping Tour</a>
						</li>
						<li class="arrow"><i class="icon-angle-right"></i></li>
						<li>{{$package->name}}</li>
					</ul>
						...
						<div class="header">
							...
							<div class="slider">
								...
								<div class="owl-carousel owl-theme">
									<img src="{{ asset('/images/packages/'.$package->mainImage)}}" alt="{{$package->altMain}}" width="100%" height="auto">
									@foreach ($package->Gallery as $gallery)
									<img src="{{ asset('/images/packages/'.$gallery->image)}}" alt="{{$gallery->altMain}}" width="100%" height="auto">
									@endforeach
								</div>
							</div>
						</div>
						<div class="tabs">
							<div class="tab-head d-none d-sm-block">
								<ul class="nav nav-tabs" id="myTab" role="tablist">
									<li class="nav-item">
									  <a class="nav-link active" aria-current="page" id="overview-tab" data-toggle="tab" href="#overview" role="tab"
									  aria-controls="overview" aria-selected="true"><h2>Overview</h2></a>
									</li>
									<li class="nav-item">
									  <a class="nav-link" aria-current="page" id="itinerary-tab" data-toggle="tab" href="#itinerary" role="tab"
									  aria-controls="itinerary" aria-selected="true"><h2>Itinerary</h2></a>
									</li>
									<li class="nav-item">
									  <a class="nav-link" aria-current="page" id="prices-tab" data-toggle="tab" href="#prices" role="tab"
									  aria-controls="prices" aria-selected="true"><h2>Prices & Accommodation</h2></a>
									</li>
									@if (count($package->General)>0)
									<li class="nav-item">
										<a class="nav-link" aria-current="page" id="info-tab" data-toggle="tab" href="#info" role="tab"
										aria-controls="info" aria-selected="true"><h2>TRIP INFORMATION</h2></a>
									  </li>
									  @endif
								  </ul>
							</div>
												...
												@foreach ($package->itineraries as $key => $itineraries)
												  ...
												  <li>
													  <div class="row">
														  ...
														  <div class="col-9"><h3>{{ $item->title }}</h3></div>
													  </div>
												  </li>
												  @endforeach
												 @endforeach
														...
														@foreach ($package->itineraries as $itineraries)
															<div class="card">
																<div class="card-header">
																	<h4>
																		<a class="accordion-toggle" data-toggle="collapse" data-parent="#pricing"
																...
																<div id="collapseOne_pricing{{ $itineraries->id }}" class="collapse {{ $loop->first ?'show':'' }}" data-parent="#pricing">
																	<div class="card-body">
																		<div id="privacy" class="accordion_styled">
																			@foreach ($itineraries->items as $item)
																				<div class="card">
																					<div class="card-header">
																						<h4>
																							<a class="accordion-toggle" data-toggle="collapse" data-parent="#privacy"
																								href="#collapseOne_privacy{{ $item->id }}">{{$item->title}}<i
																									class="indicator {{ $loop->first ?'icon-right-open':'icon-down-open' }}  float-right"></i></a>
																						</h4>
																					</div>
																					<div id="collapseOne_privacy{{ $item->id }}" class="collapse {{ $loop->first ?'show':'' }}" data-parent="#privacy">
																						<div class="card-body">
																							{!!$item->body!!}
																						</div>
																					</div>
						...
						<div class="row">
							...
							<div class="col-6">
								<div class="price text-right">
									<p>From</p><h6>{{Helper::currency_converter($package->startPrice)}}</h6>
								</div>
							</div>
						</div>
							...
							<div class="box_style_1 expose" id="booking_box">
								...
								<form action="/packages" method="post">
									...
									<div class="row ">
										...
										<div class="col-sm-12">
											...
											oninput="setCustomValidity('')"
											 ...
											 type="text" class="form-control  {{ $errors->has('name') ? ' is-invalid' : '' }}" id="name_contact" name="name" value="{{old('name')}}" placeholder="Name *">
											</div>
										</div>
										...
										<div class="col-sm-7">
											<div class="form-group">
												<input required=""
												oninvalid="this.setCustomValidity('Este Campo es requerido')"
												oninput="setCustomValidity('')" value="{{old('whats')}}" type="text" class="form-control {{ $errors->has('whats') ? ' is-invalid' : '' }}" id="whats" name="whats" placeholder="Number of Whatsapp *">
											</div>
										</div>
									...
									<div class="row">
										...
										<div class="col-6 ">
											<label style="font-size: 12px;">Children *(0 to 12)</label>
											<div class="input-group">
									...
									<div class="form-group">
										...
										oninvalid="this.setCustomValidity('Este Campo es requerido')"
										oninput="setCustomValidity('')"
										type="text" class="form-control" id="comment" name="comment" placeholder="The more information, the better *">
									</div>

									<button type="submit" class="btn btn-primary" style="width: 100%;">INQUIRE NOW!</button>
								</form>
							</div>
							<!--/box_style_1 -->
						</div>
