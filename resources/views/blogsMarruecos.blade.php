...
@endsection
@section('title', 'Blog de Viajes Marruecos')

@section('meta')
	<meta name="title" content="Blog de Viajes Marruecos">
	<meta name="keywords" content="Blog de Viajes Marruecos">
	<meta name="description" content="Bienvenido al blog de Vamos Viajando, Te invitamos para dar consejos de seguridad, alimentos y más. Nuestro Blog de Viajes Marruecos te dice todo lo que necesita saber.">
@endsection
@section('content')

{{-- <section class="parallax-window" data-parallax="scroll" data-image-src="{{ asset('/images/morocco3.jpeg')}}" data-natural-width="1400" data-natural-height="470">
	<div class="parallax-content-1"> --}}
            ...
            {{-- <div class="animated fadeInDown">
				<h1>Blog de Viajes Marruecos</h1>
			</div>
	</div>
</section> --}}
<!-- End section -->
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-7 col-sm-6 nopadding">
                @if ($mblogs[0])
                    {{-- <p>{{ $mblogss[0]->title }}</p> --}}
                    <a href="/blog-de-viajes/blog-de-viajes-marruecos/{{$mblogs[0]->slug}}">
                        <div class="item big" style="background-image: url({{ asset('/images/blogs/'.$mblogs[0]->image)}})">
                            <div class="overlay">
                                <div class="content">
                                    <h3>{{ $mblogs[0]->title }}</h3>
                                    <h6><span>{{$mblogs[0]->created_at->format('d F')}}</span></h6>
                                </div>
                            </div>
                        </div>
                    </a>
            ...
            <div class="col-lg-5 col-sm-6 nopadding">
                <div class="row nomargin">
                    @if (Arr::except($mblogs, 0))
                        @foreach ($mblogs as $mblog)
                            <div class="col-12 nopadding pl-sm-3">
                                <a href="/blog-de-viajes/blog-de-viajes-marruecos/{{$mblog->slug}}">
                                    <div class="item" style="background-image: url({{ asset('/images/blogs/'.$mblog->image)}})">
                                        <div class="overlay">
                                            <div class="content">
                                                <h3>{{ $mblog->title }}</h3>
                                                <h6><span>{{$mblog->created_at->format('d F')}}</span></h6>
                                            </div>
                                        </div>
                                    </div>
                                </a>
...
<main>
	...
	{{-- <div id="position">
		<div class="container">
			<ul>
				...
				<li>Blog de Viajes Marruecos</li>
			</ul>
		</div>
	</div> --}}
	<!-- Position -->
    <div class="featured">
        <div class="container">
            ...
            <div class="details">
                <div class="row">
                    @foreach ($mblogss as $mblog)
                    <div class="col-md-3">
                        <div class="box">
                            <a href="/blog-de-viajes/blog-de-viajes-marruecos/{{ $mblog->slug }}">
                                <div class="pic" style="background-image: url('{{ asset('/images/blogs/'.$mblog->image) }}')">
                                </div>
                            </a>
                            <div class="content">
                                <a href="/{{ $mblog->slug }}">
                            ...
                            <div class="post">
                                <div class="row nomargin">
                                    <div class="col-lg-4 col-md-5 nopadding">
                                        <a hreflang="es" href="/blog-de-viajes/blog-de-viajes-marruecos/{{$blog->slug}}"><img src="{{ asset('/images/blogs/'.$blog->image)}}" title="{{$blog->imageTitle}}" alt="Image" class="img-fluid">
                                        </a>
                                    </div>
                                    <div class="col-lg-8 col-md-7 nopadding">
                                        <div class="contant">
                                            <a hreflang="es" href="/blog-de-viajes/blog-de-viajes-marruecos/{{$blog->slug}}"><h3>{{$blog->title}}</h3></a>
                                            <h6><i class="icon-calendar-empty"></i><span>{{$blog->created_at->format(' Y/m/d')}}</span></h6>
                                            <p>
                                                {!!$blog->shortDescription!!}
                                            </p>
                                            {{-- <div class="text-right">
                                                <a hreflang="es" href="/blog-de-viajes/blog-de-viajes-marruecos/{{$blog->slug}}" class="btn btn-primary">Read more</a>
                                            </div> --}}
                                        </div>
                                    </div>
                                </div>
